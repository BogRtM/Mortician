...
namespace Deputy.Modules
{
    public static class Config
    {
        ...
        #region Deputy Primary
        private static string primarySectionTitle = deputyPrefix + "Primary";// + versionSuffix;
        public static ConfigEntry<float> ThrustDamage;
        #endregion

        #region Deputy Secondary
        private static string secondarySectionTitle = deputyPrefix + "Secondary";// + versionSuffix;
        public static ConfigEntry<float> dashCD;
        public static ConfigEntry<float> JavelinDamage;
        #endregion

        #region Deputy Utility
        private static string utilitySectionTitle = deputyPrefix + "Utility";// + versionSuffix;
        ...
        public static void ReadConfig(DeputyPlugin plugin)
        {
            ...
            modVersion = plugin.Config.Bind<string>("General", "Mod Version", DeputyPlugin.MODVERSION, "Current version; don't touch this or it will reset your config");

            if (modVersion.Value != modVersion.DefaultValue.ToString())
            {
                Log.Warning("Deputy - version mismatch detected, clearing config");
