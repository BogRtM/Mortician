...
namespace Morris.Modules {
    ...
    internal static class Prefabs
    {
        ...
        {
            GameObject model = MorrisAssets.LoadSurvivorModel(displayModelName);
            ...
            //Modules.MorrisAssets.ConvertAllRenderersToHopooShader(model);
        ...
        public static GameObject CreateBodyPrefab(string bodyName, string modelName, BodyInfo bodyInfo)
        {
            ...
            if (modelName != "mdl")
            {
                model = MorrisAssets.LoadSurvivorModel(modelName);
        ...
        private static void SetupAimAnimator(GameObject prefab, GameObject model)
        {
            ...
            aimAnimator.raisedApproachSpeed = 1080f;
