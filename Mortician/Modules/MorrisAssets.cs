...
{
    internal static class MorrisAssets
    {
        // the assetbundle to load MorrisAssets. from
        ...
        internal static void Initialize()
        {
            ...
            {
                Log.Error("AssetBundle name hasn't been changed. not loading any MorrisAssets.to avoid conflicts");
                return;
            }
        ...
        internal static void PopulateAssets()
        {
            if (!mainAssetBundle)
            {
                Log.Error("There is no AssetBundle to load MorrisAssets.from.");
                return;
            }
            ...
            // feel free to delete everything in here and load in your own MorrisAssets.instead
            // it should work fine even if left as is- even if the MorrisAssets.aren't in the bundle
            /*
            ...
            swordSwingEffect = MorrisAssets.LoadEffect("HenrySwordSwingEffect", true);
            swordHitImpactEffect = MorrisAssets.LoadEffect("ImpactHenrySlash");
            */
